...
def longest_repeated_substring(dna, k):
    """
    Returns the longest substring repeated at least k times

    Parameters:
        dna (str): Only characters "ACGT". Not an empty string.
        k (int): Minimum amount of occurrences

    Returns:
        result (str | None): Longest substring repeated at least k times
    """
    # Create tree
    for char in dna:
        pass
